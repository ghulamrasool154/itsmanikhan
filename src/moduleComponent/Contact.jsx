...
import InputField from '../absComponents/InputField'
import { BiMap, BiEnvelopeOpen, BiMobile } from "react-icons/bi";
import IconBox from '../absComponents/IconBox';
import icon1 from '../icons_images/icon9.png'
import icon2 from '../icons_images/icon10.png'
import icon3 from '../icons_images/icon11.png'
import icon4 from '../icons_images/icon12.png'
...
const Contact = () => {
	...
	const _submitDataafterEmptyFiled = (e) => {
		e.preventDefault();
		emailjs.sendForm('service_gdqsv14', 'template_y4i4yqz', form.current, 'RQ0YoqCClN9P2VU1c')
			.then((result) => {
					...
					<div className="col-lg-12">
						<div className="row justify-content-center">
							<div className="col-lg-5">
								...
								<h1 className="contact-workwithme">Let’s Have A Chat!</h1>
								<p >
									You may contact me by filling in this form any time you need professional support or have any questions. You can also fill in the form to leave your comments or feedback.
				...
				<div className="row mt-5">
					...
					<div className="col-lg-7">
						...
						<div className="contact-form text-start">
							...
							{
								Object.keys(formErrors).length === 0 && isSubmit ? <b className='thankyou'> Thank You !.......</b> : ''
							}
							<form ref={form} onSubmit={_submitDataafterEmptyFiled}>
								<div className="d-flex flex-column">
									...
									<InputField
										...
										pressed={_hanldeonChange}
									/>
									<span className='requiredmessage'> {formErrors.Telephone}</span>
